						 ...
						 implements LocationListener
{
	...
	public void onLocationChanged(Location location)
	{
		...
		System.out.println("com.weather.AppActivity::onLocationChanged " + newLatitude + ", " + newLongitude);
	...
	{
		System.out.println ("com.myweather.AppActivity, onStatusChanged: " + provider + ", " + status);
	}

	@Override
	public void onProviderEnabled(String provider)
	{
		System.out.println ("com.myweather.AppActivity, onProviderEnabled: " + provider);
	}

	@Override
	public void onProviderDisabled(String provider)
	{
		System.out.println ("com.myweather.AppActivity, onProviderDisabled: " + provider);
	}
